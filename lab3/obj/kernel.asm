...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	38a040ef          	jal	ra,ffffffffc02043d4 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	3b258593          	addi	a1,a1,946 # ffffffffc0204400 <etext+0x2>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	3ca50513          	addi	a0,a0,970 # ffffffffc0204420 <etext+0x22>
...
ffffffffc020006e:	636030ef          	jal	ra,ffffffffc02036a4 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	675030ef          	jal	ra,ffffffffc0203f22 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	63f030ef          	jal	ra,ffffffffc0203f22 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	32450513          	addi	a0,a0,804 # ffffffffc0204428 <etext+0x2a>
void print_kerninfo(void) {
...
ffffffffc020011e:	32e50513          	addi	a0,a0,814 # ffffffffc0204448 <etext+0x4a>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2d858593          	addi	a1,a1,728 # ffffffffc02043fe <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	33a50513          	addi	a0,a0,826 # ffffffffc0204468 <etext+0x6a>
...
ffffffffc0200146:	34650513          	addi	a0,a0,838 # ffffffffc0204488 <etext+0x8a>
...
ffffffffc020015a:	35250513          	addi	a0,a0,850 # ffffffffc02044a8 <etext+0xaa>
...
ffffffffc0200188:	34450513          	addi	a0,a0,836 # ffffffffc02044c8 <etext+0xca>
}
...
ffffffffc0200196:	36660613          	addi	a2,a2,870 # ffffffffc02044f8 <etext+0xfa>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	37250513          	addi	a0,a0,882 # ffffffffc0204510 <etext+0x112>
void print_stackframe(void) {
...
ffffffffc02001b2:	37a60613          	addi	a2,a2,890 # ffffffffc0204528 <etext+0x12a>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	39258593          	addi	a1,a1,914 # ffffffffc0204548 <etext+0x14a>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	39250513          	addi	a0,a0,914 # ffffffffc0204550 <etext+0x152>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	39460613          	addi	a2,a2,916 # ffffffffc0204560 <etext+0x162>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	3b458593          	addi	a1,a1,948 # ffffffffc0204588 <etext+0x18a>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	37450513          	addi	a0,a0,884 # ffffffffc0204550 <etext+0x152>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	3b060613          	addi	a2,a2,944 # ffffffffc0204598 <etext+0x19a>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3c858593          	addi	a1,a1,968 # ffffffffc02045b8 <etext+0x1ba>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	35850513          	addi	a0,a0,856 # ffffffffc0204550 <etext+0x152>
...
ffffffffc0200236:	39650513          	addi	a0,a0,918 # ffffffffc02045c8 <etext+0x1ca>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	39c50513          	addi	a0,a0,924 # ffffffffc02045f0 <etext+0x1f2>
...
ffffffffc020027e:	39e48493          	addi	s1,s1,926 # ffffffffc0204618 <etext+0x21a>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	39cb0b13          	addi	s6,s6,924 # ffffffffc0204620 <etext+0x222>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	2bca0a13          	addi	s4,s4,700 # ffffffffc0204548 <etext+0x14a>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	00c040ef          	jal	ra,ffffffffc02042a4 <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0e4040ef          	jal	ra,ffffffffc02043a0 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0d0040ef          	jal	ra,ffffffffc02043a0 <strcmp>
...
ffffffffc020030e:	0b0040ef          	jal	ra,ffffffffc02043be <strchr>
...
ffffffffc020034c:	072040ef          	jal	ra,ffffffffc02043be <strchr>
...
ffffffffc020036a:	2da50513          	addi	a0,a0,730 # ffffffffc0204640 <etext+0x242>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	72f030ef          	jal	ra,ffffffffc02043e6 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	70b030ef          	jal	ra,ffffffffc02043e6 <memcpy>
    return 0;
}
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7340306f          	j	ffffffffc0203c7c <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc02007ba:	08f76363          	bltu	a4,a5,ffffffffc0200840 <interrupt_handler+0x90>
...
ffffffffc020081e:	cb0d                	beqz	a4,ffffffffc0200850 <interrupt_handler+0xa0>
                print_ticks();
                num++; //打印次数加一
            }
            else if(num == 10){
ffffffffc0200820:	00011717          	auipc	a4,0x11
ffffffffc0200824:	cf073703          	ld	a4,-784(a4) # ffffffffc0211510 <num>
ffffffffc0200828:	47a9                	li	a5,10
ffffffffc020082a:	00f70c63          	beq	a4,a5,ffffffffc0200842 <interrupt_handler+0x92>
            break;
        default:
            print_trapframe(tf);
            break;
...
ffffffffc0200838:	30450513          	addi	a0,a0,772 # ffffffffc0204b38 <commands+0x4e0>
ffffffffc020083c:	87fff06f          	j	ffffffffc02000ba <cprintf>
            print_trapframe(tf);
ffffffffc0200840:	b739                	j	ffffffffc020074e <print_trapframe>
#endif
}
...
ffffffffc020084e:	b7c5                	j	ffffffffc020082e <interrupt_handler+0x7e>
    cprintf("%d ticks\n", TICK_NUM);
ffffffffc0200850:	06400593          	li	a1,100
ffffffffc0200854:	00004517          	auipc	a0,0x4
ffffffffc0200858:	2d450513          	addi	a0,a0,724 # ffffffffc0204b28 <commands+0x4d0>
ffffffffc020085c:	85fff0ef          	jal	ra,ffffffffc02000ba <cprintf>
                num++; //打印次数加一
ffffffffc0200860:	00011717          	auipc	a4,0x11
ffffffffc0200864:	cb070713          	addi	a4,a4,-848 # ffffffffc0211510 <num>
ffffffffc0200868:	631c                	ld	a5,0(a4)
ffffffffc020086a:	0785                	addi	a5,a5,1
ffffffffc020086c:	e31c                	sd	a5,0(a4)
ffffffffc020086e:	b7c1                	j	ffffffffc020082e <interrupt_handler+0x7e>
...
ffffffffc0200880:	14f76a63          	bltu	a4,a5,ffffffffc02009d4 <exception_handler+0x164>
ffffffffc0200884:	00004717          	auipc	a4,0x4
ffffffffc0200888:	4bc70713          	addi	a4,a4,1212 # ffffffffc0204d40 <commands+0x6e8>
...
ffffffffc020089a:	49250513          	addi	a0,a0,1170 # ffffffffc0204d28 <commands+0x6d0>
...
ffffffffc02008aa:	12051b63          	bnez	a0,ffffffffc02009e0 <exception_handler+0x170>
...
ffffffffc02008bc:	2d050513          	addi	a0,a0,720 # ffffffffc0204b88 <commands+0x530>
}
...
ffffffffc02008d0:	2dc50513          	addi	a0,a0,732 # ffffffffc0204ba8 <commands+0x550>
ffffffffc02008d4:	b7f5                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008d6:	00004517          	auipc	a0,0x4
ffffffffc02008da:	2f250513          	addi	a0,a0,754 # ffffffffc0204bc8 <commands+0x570>
ffffffffc02008de:	b7cd                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008e0:	00004517          	auipc	a0,0x4
ffffffffc02008e4:	30050513          	addi	a0,a0,768 # ffffffffc0204be0 <commands+0x588>
ffffffffc02008e8:	bfe1                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008ea:	00004517          	auipc	a0,0x4
ffffffffc02008ee:	30650513          	addi	a0,a0,774 # ffffffffc0204bf0 <commands+0x598>
ffffffffc02008f2:	b7f9                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008f4:	00004517          	auipc	a0,0x4
ffffffffc02008f8:	31c50513          	addi	a0,a0,796 # ffffffffc0204c10 <commands+0x5b8>
ffffffffc02008fc:	fbeff0ef          	jal	ra,ffffffffc02000ba <cprintf>
            if ((ret = pgfault_handler(tf)) != 0) {
ffffffffc0200900:	8522                	mv	a0,s0
ffffffffc0200902:	bf3ff0ef          	jal	ra,ffffffffc02004f4 <pgfault_handler>
...
ffffffffc020090c:	e43ff0ef          	jal	ra,ffffffffc020074e <print_trapframe>
                panic("handle pgfault failed. %e\n", ret);
ffffffffc0200910:	86a6                	mv	a3,s1
ffffffffc0200912:	00004617          	auipc	a2,0x4
ffffffffc0200916:	31660613          	addi	a2,a2,790 # ffffffffc0204c28 <commands+0x5d0>
ffffffffc020091a:	0cf00593          	li	a1,207
ffffffffc020091e:	00004517          	auipc	a0,0x4
ffffffffc0200922:	dfa50513          	addi	a0,a0,-518 # ffffffffc0204718 <commands+0xc0>
ffffffffc0200926:	a4fff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc020092a:	00004517          	auipc	a0,0x4
ffffffffc020092e:	31e50513          	addi	a0,a0,798 # ffffffffc0204c48 <commands+0x5f0>
ffffffffc0200932:	b779                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc0200934:	00004517          	auipc	a0,0x4
ffffffffc0200938:	32c50513          	addi	a0,a0,812 # ffffffffc0204c60 <commands+0x608>
...
ffffffffc0200956:	2d660613          	addi	a2,a2,726 # ffffffffc0204c28 <commands+0x5d0>
ffffffffc020095a:	0d900593          	li	a1,217
ffffffffc020095e:	00004517          	auipc	a0,0x4
ffffffffc0200962:	dba50513          	addi	a0,a0,-582 # ffffffffc0204718 <commands+0xc0>
ffffffffc0200966:	a0fff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("Environment call from U-mode\n");
ffffffffc020096a:	00004517          	auipc	a0,0x4
ffffffffc020096e:	30e50513          	addi	a0,a0,782 # ffffffffc0204c78 <commands+0x620>
ffffffffc0200972:	b7b9                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Environment call from S-mode\n");
ffffffffc0200974:	00004517          	auipc	a0,0x4
ffffffffc0200978:	32450513          	addi	a0,a0,804 # ffffffffc0204c98 <commands+0x640>
ffffffffc020097c:	b791                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Environment call from H-mode\n");
ffffffffc020097e:	00004517          	auipc	a0,0x4
ffffffffc0200982:	33a50513          	addi	a0,a0,826 # ffffffffc0204cb8 <commands+0x660>
ffffffffc0200986:	bf2d                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Environment call from M-mode\n");
ffffffffc0200988:	00004517          	auipc	a0,0x4
ffffffffc020098c:	35050513          	addi	a0,a0,848 # ffffffffc0204cd8 <commands+0x680>
ffffffffc0200990:	bf05                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Instruction page fault\n");
ffffffffc0200992:	00004517          	auipc	a0,0x4
ffffffffc0200996:	36650513          	addi	a0,a0,870 # ffffffffc0204cf8 <commands+0x6a0>
ffffffffc020099a:	b71d                	j	ffffffffc02008c0 <exception_handler+0x50>
            cprintf("Load page fault\n");
ffffffffc020099c:	00004517          	auipc	a0,0x4
ffffffffc02009a0:	37450513          	addi	a0,a0,884 # ffffffffc0204d10 <commands+0x6b8>
ffffffffc02009a4:	f16ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
            if ((ret = pgfault_handler(tf)) != 0) {
ffffffffc02009a8:	8522                	mv	a0,s0
ffffffffc02009aa:	b4bff0ef          	jal	ra,ffffffffc02004f4 <pgfault_handler>
...
ffffffffc02009b6:	d99ff0ef          	jal	ra,ffffffffc020074e <print_trapframe>
                panic("handle pgfault failed. %e\n", ret);
ffffffffc02009ba:	86a6                	mv	a3,s1
ffffffffc02009bc:	00004617          	auipc	a2,0x4
ffffffffc02009c0:	26c60613          	addi	a2,a2,620 # ffffffffc0204c28 <commands+0x5d0>
ffffffffc02009c4:	0ef00593          	li	a1,239
ffffffffc02009c8:	00004517          	auipc	a0,0x4
ffffffffc02009cc:	d5050513          	addi	a0,a0,-688 # ffffffffc0204718 <commands+0xc0>
ffffffffc02009d0:	9a5ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            print_trapframe(tf);
ffffffffc02009d4:	8522                	mv	a0,s0
}
ffffffffc02009d6:	6442                	ld	s0,16(sp)
ffffffffc02009d8:	60e2                	ld	ra,24(sp)
ffffffffc02009da:	64a2                	ld	s1,8(sp)
ffffffffc02009dc:	6105                	addi	sp,sp,32
            print_trapframe(tf);
ffffffffc02009de:	bb85                	j	ffffffffc020074e <print_trapframe>
                print_trapframe(tf);
ffffffffc02009e0:	8522                	mv	a0,s0
ffffffffc02009e2:	d6dff0ef          	jal	ra,ffffffffc020074e <print_trapframe>
                panic("handle pgfault failed. %e\n", ret);
ffffffffc02009e6:	86a6                	mv	a3,s1
ffffffffc02009e8:	00004617          	auipc	a2,0x4
ffffffffc02009ec:	24060613          	addi	a2,a2,576 # ffffffffc0204c28 <commands+0x5d0>
ffffffffc02009f0:	0f600593          	li	a1,246
ffffffffc02009f4:	00004517          	auipc	a0,0x4
ffffffffc02009f8:	d2450513          	addi	a0,a0,-732 # ffffffffc0204718 <commands+0xc0>
ffffffffc02009fc:	979ff0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0200a00 <trap>:
...
ffffffffc0200a04:	0007c363          	bltz	a5,ffffffffc0200a0a <trap+0xa>
        // interrupts
        interrupt_handler(tf);
    } else {
        // exceptions
        exception_handler(tf);
ffffffffc0200a08:	b5a5                	j	ffffffffc0200870 <exception_handler>
        interrupt_handler(tf);
ffffffffc0200a0a:	b35d                	j	ffffffffc02007b0 <interrupt_handler>
...
ffffffffc0200a70:	850a                	mv	a0,sp
    jal trap
ffffffffc0200a72:	f8fff0ef          	jal	ra,ffffffffc0200a00 <trap>
...
ffffffffc0201780:	455020ef          	jal	ra,ffffffffc02043d4 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201822:	3b3020ef          	jal	ra,ffffffffc02043d4 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201f80:	40e020ef          	jal	ra,ffffffffc020438e <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f84:	10040593          	addi	a1,s0,256
ffffffffc0201f88:	10000513          	li	a0,256
ffffffffc0201f8c:	414020ef          	jal	ra,ffffffffc02043a0 <strcmp>
...
ffffffffc0201fc2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb8c>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fc6:	392020ef          	jal	ra,ffffffffc0204358 <strlen>
...
ffffffffc0202954:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202956:	3f4010ef          	jal	ra,ffffffffc0203d4a <swapfs_init>
...
ffffffffc0202a0c:	2dd000ef          	jal	ra,ffffffffc02034e8 <mm_create>
...
ffffffffc0202a40:	2f1000ef          	jal	ra,ffffffffc0203530 <vma_create>
...
ffffffffc0202a4c:	353000ef          	jal	ra,ffffffffc020359e <insert_vma_struct>
...
ffffffffc0202c56:	219000ef          	jal	ra,ffffffffc020366e <mm_destroy>
...
ffffffffc0203060:	5bd000ef          	jal	ra,ffffffffc0203e1c <swapfs_write>
...
ffffffffc02030fe:	485000ef          	jal	ra,ffffffffc0203d82 <swapfs_read>
...
ffffffffc02033d6:	e04a                	sd	s2,0(sp)
     assert(head != NULL);
ffffffffc02033d8:	c33d                	beqz	a4,ffffffffc020343e <_clock_swap_out_victim+0x72>
     assert(in_tick==0);
ffffffffc02033da:	e251                	bnez	a2,ffffffffc020345e <_clock_swap_out_victim+0x92>
ffffffffc02033dc:	0000e497          	auipc	s1,0xe
ffffffffc02033e0:	18448493          	addi	s1,s1,388 # ffffffffc0211560 <curr_ptr>
ffffffffc02033e4:	6080                	ld	s0,0(s1)
ffffffffc02033e6:	892e                	mv	s2,a1
ffffffffc02033e8:	4681                	li	a3,0
        if(curr_ptr == head){
ffffffffc02033ea:	00870b63          	beq	a4,s0,ffffffffc0203400 <_clock_swap_out_victim+0x34>
        if(curr_page->visited == 0){
ffffffffc02033ee:	fe043783          	ld	a5,-32(s0)
ffffffffc02033f2:	cb91                	beqz	a5,ffffffffc0203406 <_clock_swap_out_victim+0x3a>
        curr_page->visited = 0;
ffffffffc02033f4:	fe043023          	sd	zero,-32(s0)
    return listelm->prev;
ffffffffc02033f8:	6000                	ld	s0,0(s0)
{
ffffffffc02033fa:	4685                	li	a3,1
        if(curr_ptr == head){
ffffffffc02033fc:	fe8719e3          	bne	a4,s0,ffffffffc02033ee <_clock_swap_out_victim+0x22>
ffffffffc0203400:	6300                	ld	s0,0(a4)
{
ffffffffc0203402:	4685                	li	a3,1
ffffffffc0203404:	bfe5                	j	ffffffffc02033fc <_clock_swap_out_victim+0x30>
ffffffffc0203406:	c291                	beqz	a3,ffffffffc020340a <_clock_swap_out_victim+0x3e>
ffffffffc0203408:	e080                	sd	s0,0(s1)
            cprintf("curr_ptr %p\n", curr_ptr);
ffffffffc020340a:	85a2                	mv	a1,s0
ffffffffc020340c:	00002517          	auipc	a0,0x2
ffffffffc0203410:	7d450513          	addi	a0,a0,2004 # ffffffffc0205be0 <default_pmm_manager+0xaa0>
ffffffffc0203414:	ca7fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc0203418:	609c                	ld	a5,0(s1)
        struct Page* curr_page = le2page(curr_ptr,pra_page_link);
ffffffffc020341a:	fd040413          	addi	s0,s0,-48
}
ffffffffc020341e:	60e2                	ld	ra,24(sp)
ffffffffc0203420:	6398                	ld	a4,0(a5)
ffffffffc0203422:	4501                	li	a0,0
    return listelm->next;
ffffffffc0203424:	671c                	ld	a5,8(a4)
            curr_ptr = list_prev(curr_ptr);
ffffffffc0203426:	e098                	sd	a4,0(s1)
}
ffffffffc0203428:	64a2                	ld	s1,8(sp)
    __list_del(listelm->prev, listelm->next);
ffffffffc020342a:	6398                	ld	a4,0(a5)
...
ffffffffc0203430:	e398                	sd	a4,0(a5)
            *ptr_page = curr_page;
ffffffffc0203432:	00893023          	sd	s0,0(s2)
}
ffffffffc0203436:	6442                	ld	s0,16(sp)
ffffffffc0203438:	6902                	ld	s2,0(sp)
ffffffffc020343a:	6105                	addi	sp,sp,32
ffffffffc020343c:	8082                	ret
     assert(head != NULL);
ffffffffc020343e:	00002697          	auipc	a3,0x2
ffffffffc0203442:	78268693          	addi	a3,a3,1922 # ffffffffc0205bc0 <default_pmm_manager+0xa80>
ffffffffc0203446:	00002617          	auipc	a2,0x2
ffffffffc020344a:	94a60613          	addi	a2,a2,-1718 # ffffffffc0204d90 <commands+0x738>
ffffffffc020344e:	04d00593          	li	a1,77
ffffffffc0203452:	00002517          	auipc	a0,0x2
ffffffffc0203456:	70e50513          	addi	a0,a0,1806 # ffffffffc0205b60 <default_pmm_manager+0xa20>
ffffffffc020345a:	f1bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc020345e:	00002697          	auipc	a3,0x2
ffffffffc0203462:	77268693          	addi	a3,a3,1906 # ffffffffc0205bd0 <default_pmm_manager+0xa90>
ffffffffc0203466:	00002617          	auipc	a2,0x2
ffffffffc020346a:	92a60613          	addi	a2,a2,-1750 # ffffffffc0204d90 <commands+0x738>
ffffffffc020346e:	04e00593          	li	a1,78
ffffffffc0203472:	00002517          	auipc	a0,0x2
ffffffffc0203476:	6ee50513          	addi	a0,a0,1774 # ffffffffc0205b60 <default_pmm_manager+0xa20>
ffffffffc020347a:	efbfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020347e <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc020347e:	0000e797          	auipc	a5,0xe
ffffffffc0203482:	0e27b783          	ld	a5,226(a5) # ffffffffc0211560 <curr_ptr>
ffffffffc0203486:	cf89                	beqz	a5,ffffffffc02034a0 <_clock_map_swappable+0x22>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203488:	751c                	ld	a5,40(a0)
ffffffffc020348a:	03060713          	addi	a4,a2,48
}
ffffffffc020348e:	4501                	li	a0,0
    __list_add(elm, listelm, listelm->next);
ffffffffc0203490:	6794                	ld	a3,8(a5)
    prev->next = next->prev = elm;
ffffffffc0203492:	e298                	sd	a4,0(a3)
ffffffffc0203494:	e798                	sd	a4,8(a5)
    elm->prev = prev;
ffffffffc0203496:	fa1c                	sd	a5,48(a2)
    page->visited = 1;   
ffffffffc0203498:	4785                	li	a5,1
    elm->next = next;
ffffffffc020349a:	fe14                	sd	a3,56(a2)
ffffffffc020349c:	ea1c                	sd	a5,16(a2)
}
ffffffffc020349e:	8082                	ret
{
ffffffffc02034a0:	1141                	addi	sp,sp,-16
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034a2:	00002697          	auipc	a3,0x2
ffffffffc02034a6:	74e68693          	addi	a3,a3,1870 # ffffffffc0205bf0 <default_pmm_manager+0xab0>
ffffffffc02034aa:	00002617          	auipc	a2,0x2
ffffffffc02034ae:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204d90 <commands+0x738>
ffffffffc02034b2:	03800593          	li	a1,56
ffffffffc02034b6:	00002517          	auipc	a0,0x2
ffffffffc02034ba:	6aa50513          	addi	a0,a0,1706 # ffffffffc0205b60 <default_pmm_manager+0xa20>
{
ffffffffc02034be:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034c0:	eb5fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034c4 <check_vma_overlap.part.0>:
}
...
ffffffffc02034ca:	76a68693          	addi	a3,a3,1898 # ffffffffc0205c30 <default_pmm_manager+0xaf0>
ffffffffc02034ce:	00002617          	auipc	a2,0x2
ffffffffc02034d2:	8c260613          	addi	a2,a2,-1854 # ffffffffc0204d90 <commands+0x738>
ffffffffc02034d6:	07d00593          	li	a1,125
ffffffffc02034da:	00002517          	auipc	a0,0x2
ffffffffc02034de:	77650513          	addi	a0,a0,1910 # ffffffffc0205c50 <default_pmm_manager+0xb10>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02034e2:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02034e4:	e91fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034e8 <mm_create>:
mm_create(void) {
ffffffffc02034e8:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034ea:	03000513          	li	a0,48
mm_create(void) {
ffffffffc02034ee:	e022                	sd	s0,0(sp)
ffffffffc02034f0:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034f2:	aa6ff0ef          	jal	ra,ffffffffc0202798 <kmalloc>
ffffffffc02034f6:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02034f8:	c105                	beqz	a0,ffffffffc0203518 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02034fa:	e408                	sd	a0,8(s0)
ffffffffc02034fc:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02034fe:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203502:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203506:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020350a:	0000e797          	auipc	a5,0xe
ffffffffc020350e:	04e7a783          	lw	a5,78(a5) # ffffffffc0211558 <swap_init_ok>
ffffffffc0203512:	eb81                	bnez	a5,ffffffffc0203522 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc0203514:	02053423          	sd	zero,40(a0)
}
...
ffffffffc0203520:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203522:	a83ff0ef          	jal	ra,ffffffffc0202fa4 <swap_init_mm>
}
ffffffffc0203526:	60a2                	ld	ra,8(sp)
ffffffffc0203528:	8522                	mv	a0,s0
ffffffffc020352a:	6402                	ld	s0,0(sp)
ffffffffc020352c:	0141                	addi	sp,sp,16
ffffffffc020352e:	8082                	ret

ffffffffc0203530 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203530:	1101                	addi	sp,sp,-32
ffffffffc0203532:	e04a                	sd	s2,0(sp)
ffffffffc0203534:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203536:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020353a:	e822                	sd	s0,16(sp)
ffffffffc020353c:	e426                	sd	s1,8(sp)
ffffffffc020353e:	ec06                	sd	ra,24(sp)
ffffffffc0203540:	84ae                	mv	s1,a1
ffffffffc0203542:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203544:	a54ff0ef          	jal	ra,ffffffffc0202798 <kmalloc>
    if (vma != NULL) {
ffffffffc0203548:	c509                	beqz	a0,ffffffffc0203552 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc020354a:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc020354e:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203550:	ed00                	sd	s0,24(a0)
}
ffffffffc0203552:	60e2                	ld	ra,24(sp)
ffffffffc0203554:	6442                	ld	s0,16(sp)
ffffffffc0203556:	64a2                	ld	s1,8(sp)
ffffffffc0203558:	6902                	ld	s2,0(sp)
ffffffffc020355a:	6105                	addi	sp,sp,32
ffffffffc020355c:	8082                	ret

ffffffffc020355e <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc020355e:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc0203560:	c505                	beqz	a0,ffffffffc0203588 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc0203562:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203564:	c501                	beqz	a0,ffffffffc020356c <find_vma+0xe>
ffffffffc0203566:	651c                	ld	a5,8(a0)
ffffffffc0203568:	02f5f263          	bgeu	a1,a5,ffffffffc020358c <find_vma+0x2e>
    return listelm->next;
ffffffffc020356c:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc020356e:	00f68d63          	beq	a3,a5,ffffffffc0203588 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203572:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203576:	00e5e663          	bltu	a1,a4,ffffffffc0203582 <find_vma+0x24>
ffffffffc020357a:	ff07b703          	ld	a4,-16(a5)
ffffffffc020357e:	00e5ec63          	bltu	a1,a4,ffffffffc0203596 <find_vma+0x38>
ffffffffc0203582:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203584:	fef697e3          	bne	a3,a5,ffffffffc0203572 <find_vma+0x14>
...
ffffffffc020358e:	fcf5ffe3          	bgeu	a1,a5,ffffffffc020356c <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203592:	ea88                	sd	a0,16(a3)
ffffffffc0203594:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203596:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc020359a:	ea88                	sd	a0,16(a3)
ffffffffc020359c:	8082                	ret

ffffffffc020359e <insert_vma_struct>:
...
ffffffffc020359e:	6590                	ld	a2,8(a1)
ffffffffc02035a0:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc02035a4:	1141                	addi	sp,sp,-16
ffffffffc02035a6:	e406                	sd	ra,8(sp)
ffffffffc02035a8:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035aa:	01066763          	bltu	a2,a6,ffffffffc02035b8 <insert_vma_struct+0x1a>
ffffffffc02035ae:	a085                	j	ffffffffc020360e <insert_vma_struct+0x70>
...
ffffffffc02035b4:	04e66863          	bltu	a2,a4,ffffffffc0203604 <insert_vma_struct+0x66>
ffffffffc02035b8:	86be                	mv	a3,a5
ffffffffc02035ba:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02035bc:	fef51ae3          	bne	a0,a5,ffffffffc02035b0 <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc02035c0:	02a68463          	beq	a3,a0,ffffffffc02035e8 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02035c4:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035c8:	fe86b883          	ld	a7,-24(a3)
ffffffffc02035cc:	08e8f163          	bgeu	a7,a4,ffffffffc020364e <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035d0:	04e66f63          	bltu	a2,a4,ffffffffc020362e <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02035d4:	00f50a63          	beq	a0,a5,ffffffffc02035e8 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc02035d8:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035dc:	05076963          	bltu	a4,a6,ffffffffc020362e <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc02035e0:	ff07b603          	ld	a2,-16(a5)
ffffffffc02035e4:	02c77363          	bgeu	a4,a2,ffffffffc020360a <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc02035e8:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02035ea:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02035ec:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02035f0:	e390                	sd	a2,0(a5)
ffffffffc02035f2:	e690                	sd	a2,8(a3)
}
ffffffffc02035f4:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02035f6:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02035f8:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02035fa:	0017079b          	addiw	a5,a4,1
ffffffffc02035fe:	d11c                	sw	a5,32(a0)
}
ffffffffc0203600:	0141                	addi	sp,sp,16
ffffffffc0203602:	8082                	ret
    if (le_prev != list) {
ffffffffc0203604:	fca690e3          	bne	a3,a0,ffffffffc02035c4 <insert_vma_struct+0x26>
ffffffffc0203608:	bfd1                	j	ffffffffc02035dc <insert_vma_struct+0x3e>
ffffffffc020360a:	ebbff0ef          	jal	ra,ffffffffc02034c4 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc020360e:	00002697          	auipc	a3,0x2
ffffffffc0203612:	65268693          	addi	a3,a3,1618 # ffffffffc0205c60 <default_pmm_manager+0xb20>
ffffffffc0203616:	00001617          	auipc	a2,0x1
ffffffffc020361a:	77a60613          	addi	a2,a2,1914 # ffffffffc0204d90 <commands+0x738>
ffffffffc020361e:	08400593          	li	a1,132
ffffffffc0203622:	00002517          	auipc	a0,0x2
ffffffffc0203626:	62e50513          	addi	a0,a0,1582 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc020362a:	d4bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020362e:	00002697          	auipc	a3,0x2
ffffffffc0203632:	67268693          	addi	a3,a3,1650 # ffffffffc0205ca0 <default_pmm_manager+0xb60>
ffffffffc0203636:	00001617          	auipc	a2,0x1
ffffffffc020363a:	75a60613          	addi	a2,a2,1882 # ffffffffc0204d90 <commands+0x738>
ffffffffc020363e:	07c00593          	li	a1,124
ffffffffc0203642:	00002517          	auipc	a0,0x2
ffffffffc0203646:	60e50513          	addi	a0,a0,1550 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc020364a:	d2bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020364e:	00002697          	auipc	a3,0x2
ffffffffc0203652:	63268693          	addi	a3,a3,1586 # ffffffffc0205c80 <default_pmm_manager+0xb40>
ffffffffc0203656:	00001617          	auipc	a2,0x1
ffffffffc020365a:	73a60613          	addi	a2,a2,1850 # ffffffffc0204d90 <commands+0x738>
ffffffffc020365e:	07b00593          	li	a1,123
ffffffffc0203662:	00002517          	auipc	a0,0x2
ffffffffc0203666:	5ee50513          	addi	a0,a0,1518 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc020366a:	d0bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020366e <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc020366e:	1141                	addi	sp,sp,-16
ffffffffc0203670:	e022                	sd	s0,0(sp)
ffffffffc0203672:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203674:	6508                	ld	a0,8(a0)
ffffffffc0203676:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203678:	00a40e63          	beq	s0,a0,ffffffffc0203694 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc020367c:	6118                	ld	a4,0(a0)
ffffffffc020367e:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203680:	03000593          	li	a1,48
ffffffffc0203684:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203686:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203688:	e398                	sd	a4,0(a5)
ffffffffc020368a:	9c8ff0ef          	jal	ra,ffffffffc0202852 <kfree>
    return listelm->next;
ffffffffc020368e:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203690:	fea416e3          	bne	s0,a0,ffffffffc020367c <mm_destroy+0xe>
    }
...
ffffffffc0203698:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020369a:	03000593          	li	a1,48
}
ffffffffc020369e:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02036a0:	9b2ff06f          	j	ffffffffc0202852 <kfree>

ffffffffc02036a4 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc02036a4:	715d                	addi	sp,sp,-80
ffffffffc02036a6:	e486                	sd	ra,72(sp)
ffffffffc02036a8:	f44e                	sd	s3,40(sp)
ffffffffc02036aa:	f052                	sd	s4,32(sp)
ffffffffc02036ac:	e0a2                	sd	s0,64(sp)
ffffffffc02036ae:	fc26                	sd	s1,56(sp)
ffffffffc02036b0:	f84a                	sd	s2,48(sp)
ffffffffc02036b2:	ec56                	sd	s5,24(sp)
ffffffffc02036b4:	e85a                	sd	s6,16(sp)
ffffffffc02036b6:	e45e                	sd	s7,8(sp)
}
...
ffffffffc02036b8:	ffbfd0ef          	jal	ra,ffffffffc02016b2 <nr_free_pages>
ffffffffc02036bc:	89aa                	mv	s3,a0
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02036be:	ff5fd0ef          	jal	ra,ffffffffc02016b2 <nr_free_pages>
ffffffffc02036c2:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02036c4:	03000513          	li	a0,48
ffffffffc02036c8:	8d0ff0ef          	jal	ra,ffffffffc0202798 <kmalloc>
    if (mm != NULL) {
ffffffffc02036cc:	56050863          	beqz	a0,ffffffffc0203c3c <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc02036d0:	e508                	sd	a0,8(a0)
ffffffffc02036d2:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02036d4:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02036d8:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02036dc:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02036e0:	0000e797          	auipc	a5,0xe
ffffffffc02036e4:	e787a783          	lw	a5,-392(a5) # ffffffffc0211558 <swap_init_ok>
ffffffffc02036e8:	84aa                	mv	s1,a0
ffffffffc02036ea:	e7b9                	bnez	a5,ffffffffc0203738 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc02036ec:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc02036f0:	03200413          	li	s0,50
ffffffffc02036f4:	a811                	j	ffffffffc0203708 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02036f6:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02036f8:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02036fa:	00053c23          	sd	zero,24(a0)
    assert(mm != NULL);
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02036fe:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203700:	8526                	mv	a0,s1
ffffffffc0203702:	e9dff0ef          	jal	ra,ffffffffc020359e <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203706:	cc05                	beqz	s0,ffffffffc020373e <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203708:	03000513          	li	a0,48
ffffffffc020370c:	88cff0ef          	jal	ra,ffffffffc0202798 <kmalloc>
ffffffffc0203710:	85aa                	mv	a1,a0
ffffffffc0203712:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203716:	f165                	bnez	a0,ffffffffc02036f6 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc0203718:	00002697          	auipc	a3,0x2
ffffffffc020371c:	15868693          	addi	a3,a3,344 # ffffffffc0205870 <default_pmm_manager+0x730>
ffffffffc0203720:	00001617          	auipc	a2,0x1
ffffffffc0203724:	67060613          	addi	a2,a2,1648 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203728:	0ce00593          	li	a1,206
ffffffffc020372c:	00002517          	auipc	a0,0x2
ffffffffc0203730:	52450513          	addi	a0,a0,1316 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203734:	c41fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203738:	86dff0ef          	jal	ra,ffffffffc0202fa4 <swap_init_mm>
ffffffffc020373c:	bf55                	j	ffffffffc02036f0 <vmm_init+0x4c>
ffffffffc020373e:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203742:	1f900913          	li	s2,505
ffffffffc0203746:	a819                	j	ffffffffc020375c <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc0203748:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc020374a:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020374c:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203750:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203752:	8526                	mv	a0,s1
ffffffffc0203754:	e4bff0ef          	jal	ra,ffffffffc020359e <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203758:	03240a63          	beq	s0,s2,ffffffffc020378c <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020375c:	03000513          	li	a0,48
ffffffffc0203760:	838ff0ef          	jal	ra,ffffffffc0202798 <kmalloc>
ffffffffc0203764:	85aa                	mv	a1,a0
ffffffffc0203766:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc020376a:	fd79                	bnez	a0,ffffffffc0203748 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc020376c:	00002697          	auipc	a3,0x2
ffffffffc0203770:	10468693          	addi	a3,a3,260 # ffffffffc0205870 <default_pmm_manager+0x730>
ffffffffc0203774:	00001617          	auipc	a2,0x1
ffffffffc0203778:	61c60613          	addi	a2,a2,1564 # ffffffffc0204d90 <commands+0x738>
ffffffffc020377c:	0d400593          	li	a1,212
ffffffffc0203780:	00002517          	auipc	a0,0x2
ffffffffc0203784:	4d050513          	addi	a0,a0,1232 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203788:	bedfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc020378c:	649c                	ld	a5,8(s1)
ffffffffc020378e:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203790:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203794:	2ef48463          	beq	s1,a5,ffffffffc0203a7c <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203798:	fe87b603          	ld	a2,-24(a5)
ffffffffc020379c:	ffe70693          	addi	a3,a4,-2
ffffffffc02037a0:	26d61e63          	bne	a2,a3,ffffffffc0203a1c <vmm_init+0x378>
ffffffffc02037a4:	ff07b683          	ld	a3,-16(a5)
ffffffffc02037a8:	26e69a63          	bne	a3,a4,ffffffffc0203a1c <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc02037ac:	0715                	addi	a4,a4,5
ffffffffc02037ae:	679c                	ld	a5,8(a5)
ffffffffc02037b0:	feb712e3          	bne	a4,a1,ffffffffc0203794 <vmm_init+0xf0>
ffffffffc02037b4:	4b1d                	li	s6,7
ffffffffc02037b6:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02037b8:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc02037bc:	85a2                	mv	a1,s0
ffffffffc02037be:	8526                	mv	a0,s1
ffffffffc02037c0:	d9fff0ef          	jal	ra,ffffffffc020355e <find_vma>
ffffffffc02037c4:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc02037c6:	2c050b63          	beqz	a0,ffffffffc0203a9c <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02037ca:	00140593          	addi	a1,s0,1
ffffffffc02037ce:	8526                	mv	a0,s1
ffffffffc02037d0:	d8fff0ef          	jal	ra,ffffffffc020355e <find_vma>
ffffffffc02037d4:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02037d6:	2e050363          	beqz	a0,ffffffffc0203abc <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02037da:	85da                	mv	a1,s6
ffffffffc02037dc:	8526                	mv	a0,s1
ffffffffc02037de:	d81ff0ef          	jal	ra,ffffffffc020355e <find_vma>
        assert(vma3 == NULL);
ffffffffc02037e2:	2e051d63          	bnez	a0,ffffffffc0203adc <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02037e6:	00340593          	addi	a1,s0,3
ffffffffc02037ea:	8526                	mv	a0,s1
ffffffffc02037ec:	d73ff0ef          	jal	ra,ffffffffc020355e <find_vma>
        assert(vma4 == NULL);
ffffffffc02037f0:	30051663          	bnez	a0,ffffffffc0203afc <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02037f4:	00440593          	addi	a1,s0,4
ffffffffc02037f8:	8526                	mv	a0,s1
ffffffffc02037fa:	d65ff0ef          	jal	ra,ffffffffc020355e <find_vma>
        assert(vma5 == NULL);
ffffffffc02037fe:	30051f63          	bnez	a0,ffffffffc0203b1c <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203802:	00893783          	ld	a5,8(s2)
ffffffffc0203806:	24879b63          	bne	a5,s0,ffffffffc0203a5c <vmm_init+0x3b8>
ffffffffc020380a:	01093783          	ld	a5,16(s2)
ffffffffc020380e:	25679763          	bne	a5,s6,ffffffffc0203a5c <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203812:	008ab783          	ld	a5,8(s5)
ffffffffc0203816:	22879363          	bne	a5,s0,ffffffffc0203a3c <vmm_init+0x398>
ffffffffc020381a:	010ab783          	ld	a5,16(s5)
ffffffffc020381e:	21679f63          	bne	a5,s6,ffffffffc0203a3c <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203822:	0415                	addi	s0,s0,5
ffffffffc0203824:	0b15                	addi	s6,s6,5
ffffffffc0203826:	f9741be3          	bne	s0,s7,ffffffffc02037bc <vmm_init+0x118>
ffffffffc020382a:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc020382c:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc020382e:	85a2                	mv	a1,s0
ffffffffc0203830:	8526                	mv	a0,s1
ffffffffc0203832:	d2dff0ef          	jal	ra,ffffffffc020355e <find_vma>
ffffffffc0203836:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc020383a:	c90d                	beqz	a0,ffffffffc020386c <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc020383c:	6914                	ld	a3,16(a0)
ffffffffc020383e:	6510                	ld	a2,8(a0)
ffffffffc0203840:	00002517          	auipc	a0,0x2
ffffffffc0203844:	58050513          	addi	a0,a0,1408 # ffffffffc0205dc0 <default_pmm_manager+0xc80>
ffffffffc0203848:	873fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020384c:	00002697          	auipc	a3,0x2
ffffffffc0203850:	59c68693          	addi	a3,a3,1436 # ffffffffc0205de8 <default_pmm_manager+0xca8>
ffffffffc0203854:	00001617          	auipc	a2,0x1
ffffffffc0203858:	53c60613          	addi	a2,a2,1340 # ffffffffc0204d90 <commands+0x738>
ffffffffc020385c:	0f600593          	li	a1,246
ffffffffc0203860:	00002517          	auipc	a0,0x2
ffffffffc0203864:	3f050513          	addi	a0,a0,1008 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203868:	b0dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc020386c:	147d                	addi	s0,s0,-1
ffffffffc020386e:	fd2410e3          	bne	s0,s2,ffffffffc020382e <vmm_init+0x18a>
ffffffffc0203872:	a811                	j	ffffffffc0203886 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203874:	6118                	ld	a4,0(a0)
ffffffffc0203876:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203878:	03000593          	li	a1,48
ffffffffc020387c:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020387e:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203880:	e398                	sd	a4,0(a5)
ffffffffc0203882:	fd1fe0ef          	jal	ra,ffffffffc0202852 <kfree>
    return listelm->next;
ffffffffc0203886:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203888:	fea496e3          	bne	s1,a0,ffffffffc0203874 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020388c:	03000593          	li	a1,48
ffffffffc0203890:	8526                	mv	a0,s1
ffffffffc0203892:	fc1fe0ef          	jal	ra,ffffffffc0202852 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203896:	e1dfd0ef          	jal	ra,ffffffffc02016b2 <nr_free_pages>
ffffffffc020389a:	3caa1163          	bne	s4,a0,ffffffffc0203c5c <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020389e:	00002517          	auipc	a0,0x2
ffffffffc02038a2:	58a50513          	addi	a0,a0,1418 # ffffffffc0205e28 <default_pmm_manager+0xce8>
ffffffffc02038a6:	815fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
ffffffffc02038ae:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02038b0:	03000513          	li	a0,48
ffffffffc02038b4:	ee5fe0ef          	jal	ra,ffffffffc0202798 <kmalloc>
ffffffffc02038b8:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02038ba:	2a050163          	beqz	a0,ffffffffc0203b5c <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038be:	0000e797          	auipc	a5,0xe
ffffffffc02038c2:	c9a7a783          	lw	a5,-870(a5) # ffffffffc0211558 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc02038c6:	e508                	sd	a0,8(a0)
ffffffffc02038c8:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02038ca:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02038ce:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02038d2:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038d6:	14079063          	bnez	a5,ffffffffc0203a16 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc02038da:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038de:	0000e917          	auipc	s2,0xe
ffffffffc02038e2:	c4293903          	ld	s2,-958(s2) # ffffffffc0211520 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc02038e6:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc02038ea:	0000e717          	auipc	a4,0xe
ffffffffc02038ee:	c6873f23          	sd	s0,-898(a4) # ffffffffc0211568 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038f2:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02038f6:	24079363          	bnez	a5,ffffffffc0203b3c <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc0203902:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc0203904:	28050063          	beqz	a0,ffffffffc0203b84 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc0203908:	002007b7          	lui	a5,0x200
ffffffffc020390c:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc0203910:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc0203912:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc0203914:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203918:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc020391a:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc020391e:	c81ff0ef          	jal	ra,ffffffffc020359e <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203922:	10000593          	li	a1,256
ffffffffc0203926:	8522                	mv	a0,s0
ffffffffc0203928:	c37ff0ef          	jal	ra,ffffffffc020355e <find_vma>
ffffffffc020392c:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203930:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203934:	26aa1863          	bne	s4,a0,ffffffffc0203ba4 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc0203938:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc020393c:	0785                	addi	a5,a5,1
ffffffffc020393e:	fee79de3          	bne	a5,a4,ffffffffc0203938 <vmm_init+0x294>
        sum += i;
ffffffffc0203942:	6705                	lui	a4,0x1
ffffffffc0203944:	10000793          	li	a5,256
ffffffffc0203948:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc020394c:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203950:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203954:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203956:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203958:	fec79ce3          	bne	a5,a2,ffffffffc0203950 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc020395c:	26071463          	bnez	a4,ffffffffc0203bc4 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203960:	4581                	li	a1,0
ffffffffc0203962:	854a                	mv	a0,s2
ffffffffc0203964:	fd9fd0ef          	jal	ra,ffffffffc020193c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203968:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc020396c:	0000e717          	auipc	a4,0xe
ffffffffc0203970:	bbc73703          	ld	a4,-1092(a4) # ffffffffc0211528 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203974:	078a                	slli	a5,a5,0x2
ffffffffc0203976:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203978:	26e7f663          	bgeu	a5,a4,ffffffffc0203be4 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc020397c:	00003717          	auipc	a4,0x3
ffffffffc0203980:	87473703          	ld	a4,-1932(a4) # ffffffffc02061f0 <nbase>
ffffffffc0203984:	8f99                	sub	a5,a5,a4
ffffffffc0203986:	00379713          	slli	a4,a5,0x3
ffffffffc020398a:	97ba                	add	a5,a5,a4
ffffffffc020398c:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc020398e:	0000e517          	auipc	a0,0xe
ffffffffc0203992:	ba253503          	ld	a0,-1118(a0) # ffffffffc0211530 <pages>
ffffffffc0203996:	953e                	add	a0,a0,a5
ffffffffc0203998:	4585                	li	a1,1
ffffffffc020399a:	cd9fd0ef          	jal	ra,ffffffffc0201672 <free_pages>
    return listelm->next;
ffffffffc020399e:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc02039a0:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc02039a4:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039a8:	00a40e63          	beq	s0,a0,ffffffffc02039c4 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc02039ac:	6118                	ld	a4,0(a0)
ffffffffc02039ae:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02039b0:	03000593          	li	a1,48
ffffffffc02039b4:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02039b6:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02039b8:	e398                	sd	a4,0(a5)
ffffffffc02039ba:	e99fe0ef          	jal	ra,ffffffffc0202852 <kfree>
    return listelm->next;
ffffffffc02039be:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039c0:	fea416e3          	bne	s0,a0,ffffffffc02039ac <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02039c4:	03000593          	li	a1,48
ffffffffc02039c8:	8522                	mv	a0,s0
ffffffffc02039ca:	e89fe0ef          	jal	ra,ffffffffc0202852 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc02039ce:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc02039d0:	0000e797          	auipc	a5,0xe
ffffffffc02039d4:	b807bc23          	sd	zero,-1128(a5) # ffffffffc0211568 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039d8:	cdbfd0ef          	jal	ra,ffffffffc02016b2 <nr_free_pages>
ffffffffc02039dc:	22a49063          	bne	s1,a0,ffffffffc0203bfc <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc02039e0:	00002517          	auipc	a0,0x2
ffffffffc02039e4:	49850513          	addi	a0,a0,1176 # ffffffffc0205e78 <default_pmm_manager+0xd38>
ffffffffc02039e8:	ed2fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039ec:	cc7fd0ef          	jal	ra,ffffffffc02016b2 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc02039f0:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039f2:	22a99563          	bne	s3,a0,ffffffffc0203c1c <vmm_init+0x578>
}
...
ffffffffc0203a0c:	49050513          	addi	a0,a0,1168 # ffffffffc0205e98 <default_pmm_manager+0xd58>
}
ffffffffc0203a10:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a12:	ea8fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a16:	d8eff0ef          	jal	ra,ffffffffc0202fa4 <swap_init_mm>
ffffffffc0203a1a:	b5d1                	j	ffffffffc02038de <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203a1c:	00002697          	auipc	a3,0x2
ffffffffc0203a20:	2bc68693          	addi	a3,a3,700 # ffffffffc0205cd8 <default_pmm_manager+0xb98>
ffffffffc0203a24:	00001617          	auipc	a2,0x1
ffffffffc0203a28:	36c60613          	addi	a2,a2,876 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203a2c:	0dd00593          	li	a1,221
ffffffffc0203a30:	00002517          	auipc	a0,0x2
ffffffffc0203a34:	22050513          	addi	a0,a0,544 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203a38:	93dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a3c:	00002697          	auipc	a3,0x2
ffffffffc0203a40:	35468693          	addi	a3,a3,852 # ffffffffc0205d90 <default_pmm_manager+0xc50>
ffffffffc0203a44:	00001617          	auipc	a2,0x1
ffffffffc0203a48:	34c60613          	addi	a2,a2,844 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203a4c:	0ee00593          	li	a1,238
ffffffffc0203a50:	00002517          	auipc	a0,0x2
ffffffffc0203a54:	20050513          	addi	a0,a0,512 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203a58:	91dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a5c:	00002697          	auipc	a3,0x2
ffffffffc0203a60:	30468693          	addi	a3,a3,772 # ffffffffc0205d60 <default_pmm_manager+0xc20>
ffffffffc0203a64:	00001617          	auipc	a2,0x1
ffffffffc0203a68:	32c60613          	addi	a2,a2,812 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203a6c:	0ed00593          	li	a1,237
ffffffffc0203a70:	00002517          	auipc	a0,0x2
ffffffffc0203a74:	1e050513          	addi	a0,a0,480 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203a78:	8fdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a7c:	00002697          	auipc	a3,0x2
ffffffffc0203a80:	24468693          	addi	a3,a3,580 # ffffffffc0205cc0 <default_pmm_manager+0xb80>
ffffffffc0203a84:	00001617          	auipc	a2,0x1
ffffffffc0203a88:	30c60613          	addi	a2,a2,780 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203a8c:	0db00593          	li	a1,219
ffffffffc0203a90:	00002517          	auipc	a0,0x2
ffffffffc0203a94:	1c050513          	addi	a0,a0,448 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203a98:	8ddfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a9c:	00002697          	auipc	a3,0x2
ffffffffc0203aa0:	27468693          	addi	a3,a3,628 # ffffffffc0205d10 <default_pmm_manager+0xbd0>
ffffffffc0203aa4:	00001617          	auipc	a2,0x1
ffffffffc0203aa8:	2ec60613          	addi	a2,a2,748 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203aac:	0e300593          	li	a1,227
ffffffffc0203ab0:	00002517          	auipc	a0,0x2
ffffffffc0203ab4:	1a050513          	addi	a0,a0,416 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203ab8:	8bdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203abc:	00002697          	auipc	a3,0x2
ffffffffc0203ac0:	26468693          	addi	a3,a3,612 # ffffffffc0205d20 <default_pmm_manager+0xbe0>
ffffffffc0203ac4:	00001617          	auipc	a2,0x1
ffffffffc0203ac8:	2cc60613          	addi	a2,a2,716 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203acc:	0e500593          	li	a1,229
ffffffffc0203ad0:	00002517          	auipc	a0,0x2
ffffffffc0203ad4:	18050513          	addi	a0,a0,384 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203ad8:	89dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203adc:	00002697          	auipc	a3,0x2
ffffffffc0203ae0:	25468693          	addi	a3,a3,596 # ffffffffc0205d30 <default_pmm_manager+0xbf0>
ffffffffc0203ae4:	00001617          	auipc	a2,0x1
ffffffffc0203ae8:	2ac60613          	addi	a2,a2,684 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203aec:	0e700593          	li	a1,231
ffffffffc0203af0:	00002517          	auipc	a0,0x2
ffffffffc0203af4:	16050513          	addi	a0,a0,352 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203af8:	87dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203afc:	00002697          	auipc	a3,0x2
ffffffffc0203b00:	24468693          	addi	a3,a3,580 # ffffffffc0205d40 <default_pmm_manager+0xc00>
ffffffffc0203b04:	00001617          	auipc	a2,0x1
ffffffffc0203b08:	28c60613          	addi	a2,a2,652 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203b0c:	0e900593          	li	a1,233
ffffffffc0203b10:	00002517          	auipc	a0,0x2
ffffffffc0203b14:	14050513          	addi	a0,a0,320 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203b18:	85dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203b1c:	00002697          	auipc	a3,0x2
ffffffffc0203b20:	23468693          	addi	a3,a3,564 # ffffffffc0205d50 <default_pmm_manager+0xc10>
ffffffffc0203b24:	00001617          	auipc	a2,0x1
ffffffffc0203b28:	26c60613          	addi	a2,a2,620 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203b2c:	0eb00593          	li	a1,235
ffffffffc0203b30:	00002517          	auipc	a0,0x2
ffffffffc0203b34:	12050513          	addi	a0,a0,288 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203b38:	83dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b3c:	00002697          	auipc	a3,0x2
ffffffffc0203b40:	d2468693          	addi	a3,a3,-732 # ffffffffc0205860 <default_pmm_manager+0x720>
ffffffffc0203b44:	00001617          	auipc	a2,0x1
ffffffffc0203b48:	24c60613          	addi	a2,a2,588 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203b4c:	10d00593          	li	a1,269
ffffffffc0203b50:	00002517          	auipc	a0,0x2
ffffffffc0203b54:	10050513          	addi	a0,a0,256 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203b58:	81dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b5c:	00002697          	auipc	a3,0x2
ffffffffc0203b60:	35468693          	addi	a3,a3,852 # ffffffffc0205eb0 <default_pmm_manager+0xd70>
ffffffffc0203b64:	00001617          	auipc	a2,0x1
ffffffffc0203b68:	22c60613          	addi	a2,a2,556 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203b6c:	10a00593          	li	a1,266
ffffffffc0203b70:	00002517          	auipc	a0,0x2
ffffffffc0203b74:	0e050513          	addi	a0,a0,224 # ffffffffc0205c50 <default_pmm_manager+0xb10>
    check_mm_struct = mm_create();
ffffffffc0203b78:	0000e797          	auipc	a5,0xe
ffffffffc0203b7c:	9e07b823          	sd	zero,-1552(a5) # ffffffffc0211568 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b80:	ff4fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b84:	00002697          	auipc	a3,0x2
ffffffffc0203b88:	cec68693          	addi	a3,a3,-788 # ffffffffc0205870 <default_pmm_manager+0x730>
ffffffffc0203b8c:	00001617          	auipc	a2,0x1
ffffffffc0203b90:	20460613          	addi	a2,a2,516 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203b94:	11100593          	li	a1,273
ffffffffc0203b98:	00002517          	auipc	a0,0x2
ffffffffc0203b9c:	0b850513          	addi	a0,a0,184 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203ba0:	fd4fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203ba4:	00002697          	auipc	a3,0x2
ffffffffc0203ba8:	2a468693          	addi	a3,a3,676 # ffffffffc0205e48 <default_pmm_manager+0xd08>
ffffffffc0203bac:	00001617          	auipc	a2,0x1
ffffffffc0203bb0:	1e460613          	addi	a2,a2,484 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203bb4:	11600593          	li	a1,278
ffffffffc0203bb8:	00002517          	auipc	a0,0x2
ffffffffc0203bbc:	09850513          	addi	a0,a0,152 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203bc0:	fb4fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203bc4:	00002697          	auipc	a3,0x2
ffffffffc0203bc8:	2a468693          	addi	a3,a3,676 # ffffffffc0205e68 <default_pmm_manager+0xd28>
ffffffffc0203bcc:	00001617          	auipc	a2,0x1
ffffffffc0203bd0:	1c460613          	addi	a2,a2,452 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203bd4:	12000593          	li	a1,288
ffffffffc0203bd8:	00002517          	auipc	a0,0x2
ffffffffc0203bdc:	07850513          	addi	a0,a0,120 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203be0:	f94fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203be4:	00001617          	auipc	a2,0x1
ffffffffc0203be8:	59460613          	addi	a2,a2,1428 # ffffffffc0205178 <default_pmm_manager+0x38>
ffffffffc0203bec:	06500593          	li	a1,101
ffffffffc0203bf0:	00001517          	auipc	a0,0x1
ffffffffc0203bf4:	5a850513          	addi	a0,a0,1448 # ffffffffc0205198 <default_pmm_manager+0x58>
ffffffffc0203bf8:	f7cfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bfc:	00002697          	auipc	a3,0x2
ffffffffc0203c00:	20468693          	addi	a3,a3,516 # ffffffffc0205e00 <default_pmm_manager+0xcc0>
ffffffffc0203c04:	00001617          	auipc	a2,0x1
ffffffffc0203c08:	18c60613          	addi	a2,a2,396 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203c0c:	12e00593          	li	a1,302
ffffffffc0203c10:	00002517          	auipc	a0,0x2
ffffffffc0203c14:	04050513          	addi	a0,a0,64 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203c18:	f5cfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c1c:	00002697          	auipc	a3,0x2
ffffffffc0203c20:	1e468693          	addi	a3,a3,484 # ffffffffc0205e00 <default_pmm_manager+0xcc0>
ffffffffc0203c24:	00001617          	auipc	a2,0x1
ffffffffc0203c28:	16c60613          	addi	a2,a2,364 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203c2c:	0bd00593          	li	a1,189
ffffffffc0203c30:	00002517          	auipc	a0,0x2
ffffffffc0203c34:	02050513          	addi	a0,a0,32 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203c38:	f3cfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c3c:	00002697          	auipc	a3,0x2
ffffffffc0203c40:	bfc68693          	addi	a3,a3,-1028 # ffffffffc0205838 <default_pmm_manager+0x6f8>
ffffffffc0203c44:	00001617          	auipc	a2,0x1
ffffffffc0203c48:	14c60613          	addi	a2,a2,332 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203c4c:	0c700593          	li	a1,199
ffffffffc0203c50:	00002517          	auipc	a0,0x2
ffffffffc0203c54:	00050513          	mv	a0,a0
ffffffffc0203c58:	f1cfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c5c:	00002697          	auipc	a3,0x2
ffffffffc0203c60:	1a468693          	addi	a3,a3,420 # ffffffffc0205e00 <default_pmm_manager+0xcc0>
ffffffffc0203c64:	00001617          	auipc	a2,0x1
ffffffffc0203c68:	12c60613          	addi	a2,a2,300 # ffffffffc0204d90 <commands+0x738>
ffffffffc0203c6c:	0fb00593          	li	a1,251
ffffffffc0203c70:	00002517          	auipc	a0,0x2
ffffffffc0203c74:	fe050513          	addi	a0,a0,-32 # ffffffffc0205c50 <default_pmm_manager+0xb10>
ffffffffc0203c78:	efcfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c7c <do_pgfault>:
...
ffffffffc0203c7c:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c7e:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
...
ffffffffc0203c88:	8432                	mv	s0,a2
ffffffffc0203c8a:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c8c:	8d3ff0ef          	jal	ra,ffffffffc020355e <find_vma>

    pgfault_num++;
ffffffffc0203c90:	0000e797          	auipc	a5,0xe
ffffffffc0203c94:	8e07a783          	lw	a5,-1824(a5) # ffffffffc0211570 <pgfault_num>
ffffffffc0203c98:	2785                	addiw	a5,a5,1
ffffffffc0203c9a:	0000e717          	auipc	a4,0xe
ffffffffc0203c9e:	8cf72b23          	sw	a5,-1834(a4) # ffffffffc0211570 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203ca2:	c159                	beqz	a0,ffffffffc0203d28 <do_pgfault+0xac>
ffffffffc0203ca4:	651c                	ld	a5,8(a0)
ffffffffc0203ca6:	08f46163          	bltu	s0,a5,ffffffffc0203d28 <do_pgfault+0xac>
...
ffffffffc0203caa:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203cac:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203cae:	8b89                	andi	a5,a5,2
ffffffffc0203cb0:	ebb1                	bnez	a5,ffffffffc0203d04 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203cb2:	75fd                	lui	a1,0xfffff
...
ffffffffc0203cb4:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203cb6:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203cb8:	85a2                	mv	a1,s0
ffffffffc0203cba:	4605                	li	a2,1
ffffffffc0203cbc:	a31fd0ef          	jal	ra,ffffffffc02016ec <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203cc0:	610c                	ld	a1,0(a0)
ffffffffc0203cc2:	c1b9                	beqz	a1,ffffffffc0203d08 <do_pgfault+0x8c>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203cc4:	0000e797          	auipc	a5,0xe
ffffffffc0203cc8:	8947a783          	lw	a5,-1900(a5) # ffffffffc0211558 <swap_init_ok>
ffffffffc0203ccc:	c7bd                	beqz	a5,ffffffffc0203d3a <do_pgfault+0xbe>
...
ffffffffc0203cd0:	0030                	addi	a2,sp,8
ffffffffc0203cd2:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203cd4:	e402                	sd	zero,8(sp)
            swap_in(mm,addr,&page);
ffffffffc0203cd6:	bfaff0ef          	jal	ra,ffffffffc02030d0 <swap_in>
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203cda:	65a2                	ld	a1,8(sp)
ffffffffc0203cdc:	6c88                	ld	a0,24(s1)
ffffffffc0203cde:	86ca                	mv	a3,s2
ffffffffc0203ce0:	8622                	mv	a2,s0
ffffffffc0203ce2:	cf5fd0ef          	jal	ra,ffffffffc02019d6 <page_insert>
            swap_map_swappable(mm,addr,page,1);
ffffffffc0203ce6:	6622                	ld	a2,8(sp)
ffffffffc0203ce8:	4685                	li	a3,1
ffffffffc0203cea:	85a2                	mv	a1,s0
ffffffffc0203cec:	8526                	mv	a0,s1
ffffffffc0203cee:	ac2ff0ef          	jal	ra,ffffffffc0202fb0 <swap_map_swappable>

            page->pra_vaddr = addr;
ffffffffc0203cf2:	67a2                	ld	a5,8(sp)
...
ffffffffc0203cf4:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203cf6:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
...
ffffffffc0203d00:	6145                	addi	sp,sp,48
ffffffffc0203d02:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203d04:	4959                	li	s2,22
ffffffffc0203d06:	b775                	j	ffffffffc0203cb2 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d08:	6c88                	ld	a0,24(s1)
ffffffffc0203d0a:	864a                	mv	a2,s2
ffffffffc0203d0c:	85a2                	mv	a1,s0
ffffffffc0203d0e:	9d3fe0ef          	jal	ra,ffffffffc02026e0 <pgdir_alloc_page>
ffffffffc0203d12:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203d14:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d16:	f3ed                	bnez	a5,ffffffffc0203cf8 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203d18:	00002517          	auipc	a0,0x2
ffffffffc0203d1c:	1e050513          	addi	a0,a0,480 # ffffffffc0205ef8 <default_pmm_manager+0xdb8>
ffffffffc0203d20:	b9afc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d24:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d26:	bfc9                	j	ffffffffc0203cf8 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d28:	85a2                	mv	a1,s0
ffffffffc0203d2a:	00002517          	auipc	a0,0x2
ffffffffc0203d2e:	19e50513          	addi	a0,a0,414 # ffffffffc0205ec8 <default_pmm_manager+0xd88>
ffffffffc0203d32:	b88fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d36:	5575                	li	a0,-3
        goto failed;
ffffffffc0203d38:	b7c1                	j	ffffffffc0203cf8 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d3a:	00002517          	auipc	a0,0x2
ffffffffc0203d3e:	1e650513          	addi	a0,a0,486 # ffffffffc0205f20 <default_pmm_manager+0xde0>
ffffffffc0203d42:	b78fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d46:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d48:	bf45                	j	ffffffffc0203cf8 <do_pgfault+0x7c>

ffffffffc0203d4a <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
void
swapfs_init(void) {
ffffffffc0203d4a:	1141                	addi	sp,sp,-16
...
ffffffffc0203d4e:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d50:	f44fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d54:	cd01                	beqz	a0,ffffffffc0203d6c <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d56:	4505                	li	a0,1
ffffffffc0203d58:	f42fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d5c:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d5e:	810d                	srli	a0,a0,0x3
ffffffffc0203d60:	0000d797          	auipc	a5,0xd
ffffffffc0203d64:	7ea7b423          	sd	a0,2024(a5) # ffffffffc0211548 <max_swap_offset>
}
ffffffffc0203d68:	0141                	addi	sp,sp,16
ffffffffc0203d6a:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203d6c:	00002617          	auipc	a2,0x2
ffffffffc0203d70:	1dc60613          	addi	a2,a2,476 # ffffffffc0205f48 <default_pmm_manager+0xe08>
ffffffffc0203d74:	45b5                	li	a1,13
ffffffffc0203d76:	00002517          	auipc	a0,0x2
ffffffffc0203d7a:	1f250513          	addi	a0,a0,498 # ffffffffc0205f68 <default_pmm_manager+0xe28>
ffffffffc0203d7e:	df6fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d82 <swapfs_read>:
...
ffffffffc0203d86:	00855793          	srli	a5,a0,0x8
ffffffffc0203d8a:	c3a5                	beqz	a5,ffffffffc0203dea <swapfs_read+0x68>
ffffffffc0203d8c:	0000d717          	auipc	a4,0xd
ffffffffc0203d90:	7bc73703          	ld	a4,1980(a4) # ffffffffc0211548 <max_swap_offset>
ffffffffc0203d94:	04e7fb63          	bgeu	a5,a4,ffffffffc0203dea <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d98:	0000d617          	auipc	a2,0xd
ffffffffc0203d9c:	79863603          	ld	a2,1944(a2) # ffffffffc0211530 <pages>
ffffffffc0203da0:	8d91                	sub	a1,a1,a2
ffffffffc0203da2:	4035d613          	srai	a2,a1,0x3
ffffffffc0203da6:	00002597          	auipc	a1,0x2
ffffffffc0203daa:	4425b583          	ld	a1,1090(a1) # ffffffffc02061e8 <error_string+0x38>
ffffffffc0203dae:	02b60633          	mul	a2,a2,a1
ffffffffc0203db2:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203db6:	00002797          	auipc	a5,0x2
ffffffffc0203dba:	43a7b783          	ld	a5,1082(a5) # ffffffffc02061f0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dbe:	0000d717          	auipc	a4,0xd
ffffffffc0203dc2:	76a73703          	ld	a4,1898(a4) # ffffffffc0211528 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203dc6:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dc8:	00c61793          	slli	a5,a2,0xc
ffffffffc0203dcc:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203dce:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dd0:	02e7f963          	bgeu	a5,a4,ffffffffc0203e02 <swapfs_read+0x80>
}
ffffffffc0203dd4:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dd6:	0000d797          	auipc	a5,0xd
ffffffffc0203dda:	76a7b783          	ld	a5,1898(a5) # ffffffffc0211540 <va_pa_offset>
ffffffffc0203dde:	46a1                	li	a3,8
ffffffffc0203de0:	963e                	add	a2,a2,a5
ffffffffc0203de2:	4505                	li	a0,1
}
ffffffffc0203de4:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203de6:	ebafc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203dea:	86aa                	mv	a3,a0
ffffffffc0203dec:	00002617          	auipc	a2,0x2
ffffffffc0203df0:	19460613          	addi	a2,a2,404 # ffffffffc0205f80 <default_pmm_manager+0xe40>
ffffffffc0203df4:	45d1                	li	a1,20
ffffffffc0203df6:	00002517          	auipc	a0,0x2
ffffffffc0203dfa:	17250513          	addi	a0,a0,370 # ffffffffc0205f68 <default_pmm_manager+0xe28>
ffffffffc0203dfe:	d76fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e02:	86b2                	mv	a3,a2
ffffffffc0203e04:	06a00593          	li	a1,106
ffffffffc0203e08:	00001617          	auipc	a2,0x1
ffffffffc0203e0c:	3c860613          	addi	a2,a2,968 # ffffffffc02051d0 <default_pmm_manager+0x90>
ffffffffc0203e10:	00001517          	auipc	a0,0x1
ffffffffc0203e14:	38850513          	addi	a0,a0,904 # ffffffffc0205198 <default_pmm_manager+0x58>
ffffffffc0203e18:	d5cfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e1c <swapfs_write>:
...
ffffffffc0203e20:	00855793          	srli	a5,a0,0x8
ffffffffc0203e24:	c3a5                	beqz	a5,ffffffffc0203e84 <swapfs_write+0x68>
ffffffffc0203e26:	0000d717          	auipc	a4,0xd
ffffffffc0203e2a:	72273703          	ld	a4,1826(a4) # ffffffffc0211548 <max_swap_offset>
ffffffffc0203e2e:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e84 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e32:	0000d617          	auipc	a2,0xd
ffffffffc0203e36:	6fe63603          	ld	a2,1790(a2) # ffffffffc0211530 <pages>
ffffffffc0203e3a:	8d91                	sub	a1,a1,a2
ffffffffc0203e3c:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e40:	00002597          	auipc	a1,0x2
ffffffffc0203e44:	3a85b583          	ld	a1,936(a1) # ffffffffc02061e8 <error_string+0x38>
ffffffffc0203e48:	02b60633          	mul	a2,a2,a1
ffffffffc0203e4c:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e50:	00002797          	auipc	a5,0x2
ffffffffc0203e54:	3a07b783          	ld	a5,928(a5) # ffffffffc02061f0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e58:	0000d717          	auipc	a4,0xd
ffffffffc0203e5c:	6d073703          	ld	a4,1744(a4) # ffffffffc0211528 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e60:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e62:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e66:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e68:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e6a:	02e7f963          	bgeu	a5,a4,ffffffffc0203e9c <swapfs_write+0x80>
}
ffffffffc0203e6e:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e70:	0000d797          	auipc	a5,0xd
ffffffffc0203e74:	6d07b783          	ld	a5,1744(a5) # ffffffffc0211540 <va_pa_offset>
ffffffffc0203e78:	46a1                	li	a3,8
ffffffffc0203e7a:	963e                	add	a2,a2,a5
ffffffffc0203e7c:	4505                	li	a0,1
}
ffffffffc0203e7e:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e80:	e44fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e84:	86aa                	mv	a3,a0
ffffffffc0203e86:	00002617          	auipc	a2,0x2
ffffffffc0203e8a:	0fa60613          	addi	a2,a2,250 # ffffffffc0205f80 <default_pmm_manager+0xe40>
ffffffffc0203e8e:	45e5                	li	a1,25
ffffffffc0203e90:	00002517          	auipc	a0,0x2
ffffffffc0203e94:	0d850513          	addi	a0,a0,216 # ffffffffc0205f68 <default_pmm_manager+0xe28>
ffffffffc0203e98:	cdcfc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e9c:	86b2                	mv	a3,a2
ffffffffc0203e9e:	06a00593          	li	a1,106
ffffffffc0203ea2:	00001617          	auipc	a2,0x1
ffffffffc0203ea6:	32e60613          	addi	a2,a2,814 # ffffffffc02051d0 <default_pmm_manager+0x90>
ffffffffc0203eaa:	00001517          	auipc	a0,0x1
ffffffffc0203eae:	2ee50513          	addi	a0,a0,750 # ffffffffc0205198 <default_pmm_manager+0x58>
ffffffffc0203eb2:	cc2fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203eb6 <printnum>:
 * */
static void
...
ffffffffc0203eb6:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203eba:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203ebc:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ec0:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203ec2:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ec6:	f022                	sd	s0,32(sp)
ffffffffc0203ec8:	ec26                	sd	s1,24(sp)
ffffffffc0203eca:	e84a                	sd	s2,16(sp)
ffffffffc0203ecc:	f406                	sd	ra,40(sp)
ffffffffc0203ece:	e44e                	sd	s3,8(sp)
ffffffffc0203ed0:	84aa                	mv	s1,a0
ffffffffc0203ed2:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203ed4:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203ed8:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203eda:	03067e63          	bgeu	a2,a6,ffffffffc0203f16 <printnum+0x60>
ffffffffc0203ede:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203ee0:	00805763          	blez	s0,ffffffffc0203eee <printnum+0x38>
ffffffffc0203ee4:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203ee6:	85ca                	mv	a1,s2
ffffffffc0203ee8:	854e                	mv	a0,s3
ffffffffc0203eea:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203eec:	fc65                	bnez	s0,ffffffffc0203ee4 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203eee:	1a02                	slli	s4,s4,0x20
ffffffffc0203ef0:	00002797          	auipc	a5,0x2
ffffffffc0203ef4:	0b078793          	addi	a5,a5,176 # ffffffffc0205fa0 <default_pmm_manager+0xe60>
ffffffffc0203ef8:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203efc:	9a3e                	add	s4,s4,a5
}
ffffffffc0203efe:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f00:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203f04:	70a2                	ld	ra,40(sp)
ffffffffc0203f06:	69a2                	ld	s3,8(sp)
ffffffffc0203f08:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f0a:	85ca                	mv	a1,s2
ffffffffc0203f0c:	87a6                	mv	a5,s1
}
ffffffffc0203f0e:	6942                	ld	s2,16(sp)
ffffffffc0203f10:	64e2                	ld	s1,24(sp)
ffffffffc0203f12:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f14:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203f16:	03065633          	divu	a2,a2,a6
ffffffffc0203f1a:	8722                	mv	a4,s0
ffffffffc0203f1c:	f9bff0ef          	jal	ra,ffffffffc0203eb6 <printnum>
ffffffffc0203f20:	b7f9                	j	ffffffffc0203eee <printnum+0x38>

ffffffffc0203f22 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f22:	7119                	addi	sp,sp,-128
ffffffffc0203f24:	f4a6                	sd	s1,104(sp)
ffffffffc0203f26:	f0ca                	sd	s2,96(sp)
ffffffffc0203f28:	ecce                	sd	s3,88(sp)
ffffffffc0203f2a:	e8d2                	sd	s4,80(sp)
ffffffffc0203f2c:	e4d6                	sd	s5,72(sp)
ffffffffc0203f2e:	e0da                	sd	s6,64(sp)
ffffffffc0203f30:	fc5e                	sd	s7,56(sp)
ffffffffc0203f32:	f06a                	sd	s10,32(sp)
ffffffffc0203f34:	fc86                	sd	ra,120(sp)
ffffffffc0203f36:	f8a2                	sd	s0,112(sp)
ffffffffc0203f38:	f862                	sd	s8,48(sp)
ffffffffc0203f3a:	f466                	sd	s9,40(sp)
ffffffffc0203f3c:	ec6e                	sd	s11,24(sp)
ffffffffc0203f3e:	892a                	mv	s2,a0
ffffffffc0203f40:	84ae                	mv	s1,a1
ffffffffc0203f42:	8d32                	mv	s10,a2
ffffffffc0203f44:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f46:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f4a:	5b7d                	li	s6,-1
ffffffffc0203f4c:	00002a97          	auipc	s5,0x2
ffffffffc0203f50:	088a8a93          	addi	s5,s5,136 # ffffffffc0205fd4 <default_pmm_manager+0xe94>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f54:	00002b97          	auipc	s7,0x2
ffffffffc0203f58:	25cb8b93          	addi	s7,s7,604 # ffffffffc02061b0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f5c:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f60:	001d0413          	addi	s0,s10,1
ffffffffc0203f64:	01350a63          	beq	a0,s3,ffffffffc0203f78 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f68:	c121                	beqz	a0,ffffffffc0203fa8 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f6a:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f6c:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f6e:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f70:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f74:	ff351ae3          	bne	a0,s3,ffffffffc0203f68 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f78:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f7c:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f80:	4c81                	li	s9,0
ffffffffc0203f82:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f84:	5c7d                	li	s8,-1
ffffffffc0203f86:	5dfd                	li	s11,-1
ffffffffc0203f88:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f8c:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f8e:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f92:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f96:	00140d13          	addi	s10,s0,1
ffffffffc0203f9a:	04b56263          	bltu	a0,a1,ffffffffc0203fde <vprintfmt+0xbc>
ffffffffc0203f9e:	058a                	slli	a1,a1,0x2
ffffffffc0203fa0:	95d6                	add	a1,a1,s5
ffffffffc0203fa2:	4194                	lw	a3,0(a1)
ffffffffc0203fa4:	96d6                	add	a3,a3,s5
ffffffffc0203fa6:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203fa8:	70e6                	ld	ra,120(sp)
ffffffffc0203faa:	7446                	ld	s0,112(sp)
ffffffffc0203fac:	74a6                	ld	s1,104(sp)
ffffffffc0203fae:	7906                	ld	s2,96(sp)
ffffffffc0203fb0:	69e6                	ld	s3,88(sp)
ffffffffc0203fb2:	6a46                	ld	s4,80(sp)
ffffffffc0203fb4:	6aa6                	ld	s5,72(sp)
ffffffffc0203fb6:	6b06                	ld	s6,64(sp)
ffffffffc0203fb8:	7be2                	ld	s7,56(sp)
ffffffffc0203fba:	7c42                	ld	s8,48(sp)
ffffffffc0203fbc:	7ca2                	ld	s9,40(sp)
ffffffffc0203fbe:	7d02                	ld	s10,32(sp)
ffffffffc0203fc0:	6de2                	ld	s11,24(sp)
ffffffffc0203fc2:	6109                	addi	sp,sp,128
ffffffffc0203fc4:	8082                	ret
            padc = '0';
ffffffffc0203fc6:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203fc8:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fcc:	846a                	mv	s0,s10
ffffffffc0203fce:	00140d13          	addi	s10,s0,1
ffffffffc0203fd2:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203fd6:	0ff5f593          	zext.b	a1,a1
ffffffffc0203fda:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f9e <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203fde:	85a6                	mv	a1,s1
ffffffffc0203fe0:	02500513          	li	a0,37
ffffffffc0203fe4:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203fe6:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203fea:	8d22                	mv	s10,s0
ffffffffc0203fec:	f73788e3          	beq	a5,s3,ffffffffc0203f5c <vprintfmt+0x3a>
ffffffffc0203ff0:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203ff4:	1d7d                	addi	s10,s10,-1
ffffffffc0203ff6:	ff379de3          	bne	a5,s3,ffffffffc0203ff0 <vprintfmt+0xce>
ffffffffc0203ffa:	b78d                	j	ffffffffc0203f5c <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203ffc:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc0204006:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020400a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020400e:	02d86463          	bltu	a6,a3,ffffffffc0204036 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204012:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204016:	002c169b          	slliw	a3,s8,0x2
ffffffffc020401a:	0186873b          	addw	a4,a3,s8
ffffffffc020401e:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204022:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204024:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204028:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020402a:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020402e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204032:	fed870e3          	bgeu	a6,a3,ffffffffc0204012 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204036:	f40ddce3          	bgez	s11,ffffffffc0203f8e <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020403a:	8de2                	mv	s11,s8
ffffffffc020403c:	5c7d                	li	s8,-1
ffffffffc020403e:	bf81                	j	ffffffffc0203f8e <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204040:	fffdc693          	not	a3,s11
ffffffffc0204044:	96fd                	srai	a3,a3,0x3f
ffffffffc0204046:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020404a:	00144603          	lbu	a2,1(s0)
ffffffffc020404e:	2d81                	sext.w	s11,s11
ffffffffc0204050:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204052:	bf35                	j	ffffffffc0203f8e <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204054:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0204060:	bfd9                	j	ffffffffc0204036 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204062:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204064:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204068:	01174463          	blt	a4,a7,ffffffffc0204070 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020406c:	1a088e63          	beqz	a7,ffffffffc0204228 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204070:	000a3603          	ld	a2,0(s4)
ffffffffc0204074:	46c1                	li	a3,16
ffffffffc0204076:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204078:	2781                	sext.w	a5,a5
ffffffffc020407a:	876e                	mv	a4,s11
ffffffffc020407c:	85a6                	mv	a1,s1
ffffffffc020407e:	854a                	mv	a0,s2
ffffffffc0204080:	e37ff0ef          	jal	ra,ffffffffc0203eb6 <printnum>
            break;
ffffffffc0204084:	bde1                	j	ffffffffc0203f5c <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204086:	000a2503          	lw	a0,0(s4)
ffffffffc020408a:	85a6                	mv	a1,s1
ffffffffc020408c:	0a21                	addi	s4,s4,8
ffffffffc020408e:	9902                	jalr	s2
            break;
ffffffffc0204090:	b5f1                	j	ffffffffc0203f5c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204092:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204094:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204098:	01174463          	blt	a4,a7,ffffffffc02040a0 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020409c:	18088163          	beqz	a7,ffffffffc020421e <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc02040a0:	000a3603          	ld	a2,0(s4)
ffffffffc02040a4:	46a9                	li	a3,10
ffffffffc02040a6:	8a2e                	mv	s4,a1
ffffffffc02040a8:	bfc1                	j	ffffffffc0204078 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040aa:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc02040ae:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040b0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040b2:	bdf1                	j	ffffffffc0203f8e <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc02040b4:	85a6                	mv	a1,s1
ffffffffc02040b6:	02500513          	li	a0,37
ffffffffc02040ba:	9902                	jalr	s2
            break;
ffffffffc02040bc:	b545                	j	ffffffffc0203f5c <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040be:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc02040c2:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040c4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040c6:	b5e1                	j	ffffffffc0203f8e <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc02040c8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040ca:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040ce:	01174463          	blt	a4,a7,ffffffffc02040d6 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc02040d2:	14088163          	beqz	a7,ffffffffc0204214 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc02040d6:	000a3603          	ld	a2,0(s4)
ffffffffc02040da:	46a1                	li	a3,8
ffffffffc02040dc:	8a2e                	mv	s4,a1
ffffffffc02040de:	bf69                	j	ffffffffc0204078 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02040e0:	03000513          	li	a0,48
ffffffffc02040e4:	85a6                	mv	a1,s1
ffffffffc02040e6:	e03e                	sd	a5,0(sp)
ffffffffc02040e8:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040ea:	85a6                	mv	a1,s1
ffffffffc02040ec:	07800513          	li	a0,120
ffffffffc02040f0:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040f2:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040f4:	6782                	ld	a5,0(sp)
ffffffffc02040f6:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040f8:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040fc:	bfb5                	j	ffffffffc0204078 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040fe:	000a3403          	ld	s0,0(s4)
ffffffffc0204102:	008a0713          	addi	a4,s4,8
ffffffffc0204106:	e03a                	sd	a4,0(sp)
ffffffffc0204108:	14040263          	beqz	s0,ffffffffc020424c <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc020410c:	0fb05763          	blez	s11,ffffffffc02041fa <vprintfmt+0x2d8>
ffffffffc0204110:	02d00693          	li	a3,45
ffffffffc0204114:	0cd79163          	bne	a5,a3,ffffffffc02041d6 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204118:	00044783          	lbu	a5,0(s0)
ffffffffc020411c:	0007851b          	sext.w	a0,a5
ffffffffc0204120:	cf85                	beqz	a5,ffffffffc0204158 <vprintfmt+0x236>
ffffffffc0204122:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204126:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020412a:	000c4563          	bltz	s8,ffffffffc0204134 <vprintfmt+0x212>
ffffffffc020412e:	3c7d                	addiw	s8,s8,-1
ffffffffc0204130:	036c0263          	beq	s8,s6,ffffffffc0204154 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204134:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204136:	0e0c8e63          	beqz	s9,ffffffffc0204232 <vprintfmt+0x310>
ffffffffc020413a:	3781                	addiw	a5,a5,-32
ffffffffc020413c:	0ef47b63          	bgeu	s0,a5,ffffffffc0204232 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204140:	03f00513          	li	a0,63
ffffffffc0204144:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204146:	000a4783          	lbu	a5,0(s4)
ffffffffc020414a:	3dfd                	addiw	s11,s11,-1
ffffffffc020414c:	0a05                	addi	s4,s4,1
ffffffffc020414e:	0007851b          	sext.w	a0,a5
ffffffffc0204152:	ffe1                	bnez	a5,ffffffffc020412a <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204154:	01b05963          	blez	s11,ffffffffc0204166 <vprintfmt+0x244>
ffffffffc0204158:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc020415a:	85a6                	mv	a1,s1
ffffffffc020415c:	02000513          	li	a0,32
ffffffffc0204160:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204162:	fe0d9be3          	bnez	s11,ffffffffc0204158 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204166:	6a02                	ld	s4,0(sp)
ffffffffc0204168:	bbd5                	j	ffffffffc0203f5c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020416a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020416c:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204170:	01174463          	blt	a4,a7,ffffffffc0204178 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204174:	08088d63          	beqz	a7,ffffffffc020420e <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204178:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020417c:	0a044d63          	bltz	s0,ffffffffc0204236 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204180:	8622                	mv	a2,s0
ffffffffc0204182:	8a66                	mv	s4,s9
ffffffffc0204184:	46a9                	li	a3,10
ffffffffc0204186:	bdcd                	j	ffffffffc0204078 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204188:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020418c:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc020418e:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204190:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204194:	8fb5                	xor	a5,a5,a3
ffffffffc0204196:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020419a:	02d74163          	blt	a4,a3,ffffffffc02041bc <vprintfmt+0x29a>
ffffffffc020419e:	00369793          	slli	a5,a3,0x3
ffffffffc02041a2:	97de                	add	a5,a5,s7
ffffffffc02041a4:	639c                	ld	a5,0(a5)
ffffffffc02041a6:	cb99                	beqz	a5,ffffffffc02041bc <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc02041a8:	86be                	mv	a3,a5
ffffffffc02041aa:	00002617          	auipc	a2,0x2
ffffffffc02041ae:	e2660613          	addi	a2,a2,-474 # ffffffffc0205fd0 <default_pmm_manager+0xe90>
ffffffffc02041b2:	85a6                	mv	a1,s1
ffffffffc02041b4:	854a                	mv	a0,s2
ffffffffc02041b6:	0ce000ef          	jal	ra,ffffffffc0204284 <printfmt>
ffffffffc02041ba:	b34d                	j	ffffffffc0203f5c <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc02041bc:	00002617          	auipc	a2,0x2
ffffffffc02041c0:	e0460613          	addi	a2,a2,-508 # ffffffffc0205fc0 <default_pmm_manager+0xe80>
ffffffffc02041c4:	85a6                	mv	a1,s1
ffffffffc02041c6:	854a                	mv	a0,s2
ffffffffc02041c8:	0bc000ef          	jal	ra,ffffffffc0204284 <printfmt>
ffffffffc02041cc:	bb41                	j	ffffffffc0203f5c <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02041ce:	00002417          	auipc	s0,0x2
ffffffffc02041d2:	dea40413          	addi	s0,s0,-534 # ffffffffc0205fb8 <default_pmm_manager+0xe78>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041d6:	85e2                	mv	a1,s8
ffffffffc02041d8:	8522                	mv	a0,s0
ffffffffc02041da:	e43e                	sd	a5,8(sp)
ffffffffc02041dc:	196000ef          	jal	ra,ffffffffc0204372 <strnlen>
ffffffffc02041e0:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041e4:	01b05b63          	blez	s11,ffffffffc02041fa <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041e8:	67a2                	ld	a5,8(sp)
ffffffffc02041ea:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041ee:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02041f0:	85a6                	mv	a1,s1
ffffffffc02041f2:	8552                	mv	a0,s4
ffffffffc02041f4:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041f6:	fe0d9ce3          	bnez	s11,ffffffffc02041ee <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041fa:	00044783          	lbu	a5,0(s0)
ffffffffc02041fe:	00140a13          	addi	s4,s0,1
ffffffffc0204202:	0007851b          	sext.w	a0,a5
ffffffffc0204206:	d3a5                	beqz	a5,ffffffffc0204166 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204208:	05e00413          	li	s0,94
ffffffffc020420c:	bf39                	j	ffffffffc020412a <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc020420e:	000a2403          	lw	s0,0(s4)
ffffffffc0204212:	b7ad                	j	ffffffffc020417c <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204214:	000a6603          	lwu	a2,0(s4)
ffffffffc0204218:	46a1                	li	a3,8
ffffffffc020421a:	8a2e                	mv	s4,a1
ffffffffc020421c:	bdb1                	j	ffffffffc0204078 <vprintfmt+0x156>
ffffffffc020421e:	000a6603          	lwu	a2,0(s4)
ffffffffc0204222:	46a9                	li	a3,10
ffffffffc0204224:	8a2e                	mv	s4,a1
ffffffffc0204226:	bd89                	j	ffffffffc0204078 <vprintfmt+0x156>
ffffffffc0204228:	000a6603          	lwu	a2,0(s4)
ffffffffc020422c:	46c1                	li	a3,16
ffffffffc020422e:	8a2e                	mv	s4,a1
ffffffffc0204230:	b5a1                	j	ffffffffc0204078 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204232:	9902                	jalr	s2
ffffffffc0204234:	bf09                	j	ffffffffc0204146 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204236:	85a6                	mv	a1,s1
ffffffffc0204238:	02d00513          	li	a0,45
ffffffffc020423c:	e03e                	sd	a5,0(sp)
ffffffffc020423e:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204240:	6782                	ld	a5,0(sp)
ffffffffc0204242:	8a66                	mv	s4,s9
ffffffffc0204244:	40800633          	neg	a2,s0
ffffffffc0204248:	46a9                	li	a3,10
ffffffffc020424a:	b53d                	j	ffffffffc0204078 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc020424c:	03b05163          	blez	s11,ffffffffc020426e <vprintfmt+0x34c>
ffffffffc0204250:	02d00693          	li	a3,45
ffffffffc0204254:	f6d79de3          	bne	a5,a3,ffffffffc02041ce <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204258:	00002417          	auipc	s0,0x2
ffffffffc020425c:	d6040413          	addi	s0,s0,-672 # ffffffffc0205fb8 <default_pmm_manager+0xe78>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204260:	02800793          	li	a5,40
ffffffffc0204264:	02800513          	li	a0,40
ffffffffc0204268:	00140a13          	addi	s4,s0,1
ffffffffc020426c:	bd6d                	j	ffffffffc0204126 <vprintfmt+0x204>
ffffffffc020426e:	00002a17          	auipc	s4,0x2
ffffffffc0204272:	d4ba0a13          	addi	s4,s4,-693 # ffffffffc0205fb9 <default_pmm_manager+0xe79>
ffffffffc0204276:	02800513          	li	a0,40
ffffffffc020427a:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020427e:	05e00413          	li	s0,94
ffffffffc0204282:	b565                	j	ffffffffc020412a <vprintfmt+0x208>

ffffffffc0204284 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204284:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204286:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020428a:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020428c:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020428e:	ec06                	sd	ra,24(sp)
ffffffffc0204290:	f83a                	sd	a4,48(sp)
ffffffffc0204292:	fc3e                	sd	a5,56(sp)
ffffffffc0204294:	e0c2                	sd	a6,64(sp)
ffffffffc0204296:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204298:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020429a:	c89ff0ef          	jal	ra,ffffffffc0203f22 <vprintfmt>
}
ffffffffc020429e:	60e2                	ld	ra,24(sp)
ffffffffc02042a0:	6161                	addi	sp,sp,80
ffffffffc02042a2:	8082                	ret

ffffffffc02042a4 <readline>:
...
ffffffffc02042a4:	715d                	addi	sp,sp,-80
ffffffffc02042a6:	e486                	sd	ra,72(sp)
ffffffffc02042a8:	e0a6                	sd	s1,64(sp)
ffffffffc02042aa:	fc4a                	sd	s2,56(sp)
ffffffffc02042ac:	f84e                	sd	s3,48(sp)
ffffffffc02042ae:	f452                	sd	s4,40(sp)
ffffffffc02042b0:	f056                	sd	s5,32(sp)
ffffffffc02042b2:	ec5a                	sd	s6,24(sp)
ffffffffc02042b4:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc02042b6:	c901                	beqz	a0,ffffffffc02042c6 <readline+0x22>
ffffffffc02042b8:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc02042ba:	00002517          	auipc	a0,0x2
ffffffffc02042be:	d1650513          	addi	a0,a0,-746 # ffffffffc0205fd0 <default_pmm_manager+0xe90>
ffffffffc02042c2:	df9fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc02042c6:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc02042c8:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc02042ca:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc02042cc:	4aa9                	li	s5,10
ffffffffc02042ce:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc02042d0:	0000db97          	auipc	s7,0xd
ffffffffc02042d4:	e28b8b93          	addi	s7,s7,-472 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042d8:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042dc:	e17fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042e0:	00054a63          	bltz	a0,ffffffffc02042f4 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042e4:	00a95a63          	bge	s2,a0,ffffffffc02042f8 <readline+0x54>
ffffffffc02042e8:	029a5263          	bge	s4,s1,ffffffffc020430c <readline+0x68>
        c = getchar();
ffffffffc02042ec:	e07fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042f0:	fe055ae3          	bgez	a0,ffffffffc02042e4 <readline+0x40>
            return NULL;
ffffffffc02042f4:	4501                	li	a0,0
ffffffffc02042f6:	a091                	j	ffffffffc020433a <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042f8:	03351463          	bne	a0,s3,ffffffffc0204320 <readline+0x7c>
ffffffffc02042fc:	e8a9                	bnez	s1,ffffffffc020434e <readline+0xaa>
        c = getchar();
ffffffffc02042fe:	df5fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204302:	fe0549e3          	bltz	a0,ffffffffc02042f4 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204306:	fea959e3          	bge	s2,a0,ffffffffc02042f8 <readline+0x54>
ffffffffc020430a:	4481                	li	s1,0
            cputchar(c);
ffffffffc020430c:	e42a                	sd	a0,8(sp)
ffffffffc020430e:	de3fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc0204312:	6522                	ld	a0,8(sp)
ffffffffc0204314:	009b87b3          	add	a5,s7,s1
ffffffffc0204318:	2485                	addiw	s1,s1,1
ffffffffc020431a:	00a78023          	sb	a0,0(a5)
ffffffffc020431e:	bf7d                	j	ffffffffc02042dc <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc0204320:	01550463          	beq	a0,s5,ffffffffc0204328 <readline+0x84>
ffffffffc0204324:	fb651ce3          	bne	a0,s6,ffffffffc02042dc <readline+0x38>
            cputchar(c);
ffffffffc0204328:	dc9fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc020432c:	0000d517          	auipc	a0,0xd
ffffffffc0204330:	dcc50513          	addi	a0,a0,-564 # ffffffffc02110f8 <buf>
...
ffffffffc020433c:	6486                	ld	s1,64(sp)
ffffffffc020433e:	7962                	ld	s2,56(sp)
ffffffffc0204340:	79c2                	ld	s3,48(sp)
ffffffffc0204342:	7a22                	ld	s4,40(sp)
ffffffffc0204344:	7a82                	ld	s5,32(sp)
ffffffffc0204346:	6b62                	ld	s6,24(sp)
ffffffffc0204348:	6bc2                	ld	s7,16(sp)
ffffffffc020434a:	6161                	addi	sp,sp,80
ffffffffc020434c:	8082                	ret
            cputchar(c);
ffffffffc020434e:	4521                	li	a0,8
ffffffffc0204350:	da1fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204354:	34fd                	addiw	s1,s1,-1
ffffffffc0204356:	b759                	j	ffffffffc02042dc <readline+0x38>

ffffffffc0204358 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204358:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc020435c:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020435e:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204360:	cb81                	beqz	a5,ffffffffc0204370 <strlen+0x18>
        cnt ++;
ffffffffc0204362:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204364:	00a707b3          	add	a5,a4,a0
ffffffffc0204368:	0007c783          	lbu	a5,0(a5)
ffffffffc020436c:	fbfd                	bnez	a5,ffffffffc0204362 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204372:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204374:	e589                	bnez	a1,ffffffffc020437e <strnlen+0xc>
ffffffffc0204376:	a811                	j	ffffffffc020438a <strnlen+0x18>
        cnt ++;
ffffffffc0204378:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020437a:	00f58863          	beq	a1,a5,ffffffffc020438a <strnlen+0x18>
ffffffffc020437e:	00f50733          	add	a4,a0,a5
ffffffffc0204382:	00074703          	lbu	a4,0(a4)
ffffffffc0204386:	fb6d                	bnez	a4,ffffffffc0204378 <strnlen+0x6>
ffffffffc0204388:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020438a:	852e                	mv	a0,a1
ffffffffc020438c:	8082                	ret

ffffffffc020438e <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc020438e:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204390:	0005c703          	lbu	a4,0(a1)
ffffffffc0204394:	0785                	addi	a5,a5,1
ffffffffc0204396:	0585                	addi	a1,a1,1
ffffffffc0204398:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020439c:	fb75                	bnez	a4,ffffffffc0204390 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043a0:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02043a4:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043a8:	cb89                	beqz	a5,ffffffffc02043ba <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc02043aa:	0505                	addi	a0,a0,1
ffffffffc02043ac:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043ae:	fee789e3          	beq	a5,a4,ffffffffc02043a0 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02043b2:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc02043b6:	9d19                	subw	a0,a0,a4
ffffffffc02043b8:	8082                	ret
ffffffffc02043ba:	4501                	li	a0,0
ffffffffc02043bc:	bfed                	j	ffffffffc02043b6 <strcmp+0x16>
...
ffffffffc02043c2:	c799                	beqz	a5,ffffffffc02043d0 <strchr+0x12>
        if (*s == c) {
ffffffffc02043c4:	00f58763          	beq	a1,a5,ffffffffc02043d2 <strchr+0x14>
    while (*s != '\0') {
ffffffffc02043c8:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02043cc:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02043ce:	fbfd                	bnez	a5,ffffffffc02043c4 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02043d4:	ca01                	beqz	a2,ffffffffc02043e4 <memset+0x10>
ffffffffc02043d6:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02043d8:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02043da:	0785                	addi	a5,a5,1
ffffffffc02043dc:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02043e0:	fec79de3          	bne	a5,a2,ffffffffc02043da <memset+0x6>
    }
    return s;
...
ffffffffc02043e6 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043e6:	ca19                	beqz	a2,ffffffffc02043fc <memcpy+0x16>
ffffffffc02043e8:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043ea:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043ec:	0005c703          	lbu	a4,0(a1)
ffffffffc02043f0:	0585                	addi	a1,a1,1
ffffffffc02043f2:	0785                	addi	a5,a5,1
ffffffffc02043f4:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043f8:	fec59ae3          	bne	a1,a2,ffffffffc02043ec <memcpy+0x6>
    }
    return dst;
